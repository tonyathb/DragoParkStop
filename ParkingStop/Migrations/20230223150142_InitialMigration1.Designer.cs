...
namespace ParkingStop.Migrations
{
    ...
    [Migration("20230223150142_InitialMigration1")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ParkingStop.Data.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ParkingStop.Data.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ParkingStop.Data.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ParkingStop.Data.Reservation", b =>
                {
                    b.HasOne("ParkingStop.Data.ParkingPlace", "ParkingPlaces")
                        .WithMany("Reservations")
                        .HasForeignKey("ParkingPlaceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ParkingStop.Data.User", "Users")
                        .WithMany("Reservations")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
